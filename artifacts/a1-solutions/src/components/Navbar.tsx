...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between" style={{ minHeight: '64px' }}>
        {/* Logo */}
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="font-['Barlow_Condensed'] text-xl sm:text-2xl text-[#FF8C00] font-bold tracking-widest uppercase leading-none">
              A1 Solutions
            </span>
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8" role="list">
          {['services', 'about', 'coverage', 'contact'].map((section) => (
            <button
              ...
              style={{ minHeight: '44px', minWidth: '44px', padding: '0.75rem 0.5rem', fontSize: 'clamp(0.75rem, 1vw, 0.875rem)' }}
            >
              {section}
        ...
        <motion.a
          ...
          className="hidden md:flex items-center gap-2 bg-[#FF8C00] text-[#0D0D0D] font-bold font-['Barlow_Condensed'] tracking-wide uppercase"
          style={{ minHeight: '48px', padding: '0.75rem 1.25rem', fontSize: 'clamp(0.75rem, 1vw, 0.875rem)' }}
      ...
      {menuOpen && (
        <motion.div
          className="md:hidden bg-[#1A1A1A] border-t border-[#FF8C00]/30 px-4 py-4 flex flex-col gap-2"
        ...
        >
          {['services', 'about', 'coverage', 'contact'].map((section) => (
            <button
              ...
              style={{ minHeight: '48px', padding: '0.75rem 0.25rem', fontSize: '1rem' }}
            >
              {section}
            </button>
          ))}
